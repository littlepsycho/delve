...
func TestStacktraceGoroutine(t *testing.T) {
	...
	if goversion.RuntimeAfterOrEqual(1, 11) {
		mainStack[0].line = 15
	}
...
func TestStepReturnAndPanic(t *testing.T) {
	...
	switch {
	case goversion.RuntimeAfterOrEqual(1, 11):
		testseq("defercall", contStep, []nextTest{
			...
			{18, 6},
			{6, 7}}, "", t)
	case goversion.RuntimeAfterOrEqual(1, 10):
		testseq("defercall", contStep, []nextTest{
			{17, 5},
			{5, 6},
			{6, 7},
			...
			{5, 6},
			{6, 7}}, "", t)
	case goversion.RuntimeAfterOrEqual(1, 9):
		testseq("defercall", contStep, []nextTest{
			{17, 5},
			{5, 6},
			{6, 7},
...
func TestStepIgnorePrivateRuntime(t *testing.T) {
	...
	case goversion.RuntimeAfterOrEqual(1, 10):
		testseq("teststepprog", contStep, []nextTest{
			...
			{14, 15},
			{15, 22}}, "", t)
	case goversion.RuntimeAfterOrEqual(1, 7):
		testseq("teststepprog", contStep, []nextTest{
			{21, 13},
			{13, 14},
			{14, 15},
